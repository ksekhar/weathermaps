...
Gem::Specification.new do |s|
  ...
  s.email = ["sasaki.takeru@gmail.com", "joshsmoore@gmail.com", "woodie@netpress.com"]
  ...
  s.summary = %q{We intend to provide a common set of config files for Rails 2.3.5, 2.3.8, 2.3.9 and 2.3.10 on Google App Engine.}
